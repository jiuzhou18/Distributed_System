...
public class Peer extends UnicastRemoteObject implements PeerI{
	...
	private static int Port = 1101; //Each peer has different port. 
	private static String filepath = "files"; //The relative path where saves those txt files.
	private static String peerid = "01";
	...
	private static String[] neighbours = {"rmi://127.0.0.1:1102/Peer","rmi://127.0.0.1:1103/Peer",
	"rmi://127.0.0.1:1104/Peer","rmi://127.0.0.1:1105/Peer","rmi://127.0.0.1:1106/Peer","rmi://127.0.0.1:1107/Peer",
	"rmi://127.0.0.1:1108/Peer","rmi://127.0.0.1:1109/Peer","rmi://127.0.0.1:1110/Peer"}; 
