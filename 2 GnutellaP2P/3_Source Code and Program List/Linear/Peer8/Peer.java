...
public class Peer extends UnicastRemoteObject implements PeerI{
	...
	private static int Port = 1108; //Each peer has different port. 
	private static String filepath = "files"; //The relative path where saves those txt files.
	private static String peerid = "08";
	...
	private static String[] neighbours = {"rmi://127.0.0.1:1107/Peer","rmi://127.0.0.1:1109/Peer"}; 
