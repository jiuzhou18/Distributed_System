...
public class Peer extends UnicastRemoteObject implements PeerI{
	...
	private static int Port = 1102; //Each peer has different port. 
	private static String filepath = "files"; //The relative path where saves those txt files.
	private static String peerid = "02";
	...
	private static String[] neighbours = {"rmi://127.0.0.1:1101/Peer","rmi://127.0.0.1:1103/Peer"}; 
